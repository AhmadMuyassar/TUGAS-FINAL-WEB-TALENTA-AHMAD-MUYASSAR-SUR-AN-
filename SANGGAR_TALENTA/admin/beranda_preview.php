...
<div class="admin-preview-wrap">
    ...
    <div class="admin-preview-editbar">
        <a href="kelola_konten.php?tab=slide">✏ Edit Slide</a>
        <a href="kelola_kostum.php">✏ Edit Kostum Favorit</a>
        <a href="kelola_konten.php?tab=pelatihan">✏ Edit Pelatihan</a>
        <a href="kelola_konten.php?tab=karya">✏ Edit Karya</a>
        <a href="kelola_konten.php?tab=event">✏ Edit Event</a>
    </div>
    ...
    <div class="hero-slider" id="heroSliderPreview">
        ...
        <div class="hero-slide <?php echo $i===0?'active':''; ?>" style="background:<?php echo $il['warna']; ?>;">
            <div class="hero-slide-content">
                <p class="hero-slide-tag">✦ Belum ada slide aktif ✦</p>
...
<section class="home-section bg-dark">
    <div class="home-container">
        ...
        <div class="pelatihan-grid">
            ...
            <div class="pelatihan-card"><div class="pelatihan-icon">🎭</div><h3>Belum ada pelatihan</h3><p>Tambahkan dari Kelola Konten.</p></div>
            ...
            <div class="pelatihan-card">
                ...
                <?php else: ?><div class="pelatihan-icon">🎭</div><?php endif; ?>
                <h3><?php echo htmlspecialchars($p['nama_pelatihan']); ?></h3>
                <?php if (!empty($p['jadwal'])): ?><p class="pelatihan-jadwal">🕐 <?php echo htmlspecialchars($p['jadwal']); ?></p><?php endif; ?>
...
<section class="home-section bg-cream">
    <div class="home-container">
        ...
        <div class="karya-layout">
            <div class="karya-featured">
                <div class="karya-ilust-big">
                    ...
                    <?php else: ?><div class="karya-no-img">♦</div><?php endif; ?>
                </div>
        ...
        <?php else: ?>
        <p style="text-align:center;color:#888;">Belum ada karya. Tambahkan dari Kelola Konten → Hasil Karya.</p>
        <?php endif; ?>
    </div>
</section>
...
<section class="home-section bg-white">
    <div class="home-container">
        ...
        <?php else: ?>
        <p style="text-align:center;color:#888;">Belum ada event. Tambahkan dari Kelola Konten → Event & Prestasi.</p>
        <?php endif; ?>
    </div>
</section>
